import { VersionDecoder } from './../decoders';

export const version = 29406;
...
export const gameEventIdTypeId = 0;
...
export const messageEventIdTypeId = 1;
...
export const trackerEventIdTypeId = 2;
export const svaruint32TypeId = 7;
export const replayUseridTypeid = 8;
export const replayHeaderTypeid = 17;
export const gameDetailsTypeid = 39;
export const replayInitdataTypeid = 67;


export function decodeReplayHeader(content) {
  let decoder = new VersionDecoder(content, typeInfos);
